...
public class ItemSpriteSheet {
	...
	public static final int ARMOR_IZUNA	    = ARMOR+13;
	static{
	...
	public static final int THROWING_SET	= UNIQUE_ITEM+15;
	static {
		assignItemRect(SUPER_NOVA, 		16, 16);
		assignItemRect(SMOKE_GRENADE, 	12, 12);
		assignItemRect(HAND_GRENADE, 	11, 11);
		...
		assignItemRect(THROWING_SET, 	16, 16);
	}
	...
	public static final int SPIRIT_SHURIKEN		= BULLET+7;
	public static final int SPIRIT_KUNAI		= BULLET+8;
	static{
		...
		assignItemRect(SPIRIT_SHURIKEN,  12, 12);
		assignItemRect(SPIRIT_KUNAI,  15, 15);
	}
	...
	private static final int GL  =                                   xy(9, 35);  //8 slots
	...
	private static final int HG  =                                   xy(1, 36);  //8 slots
	...
	private static final int MG  =                                   xy(9, 36);  //8 slots
	...
	private static final int SG  =                                   xy(1, 37);  //8 slots
	...
	private static final int SMG  =                                   xy(9, 37);  //8 slots
