...
public enum Languages {
	KOREAN("한국어",      	"ko", Status._COMPLETE_, new String[]{"Cocoa(Hoto-Mocha)", "and SHPD's credit"}, null),
	JAPANESE("日本語",       "ja", Status.UNFINISHED, new String[]{"IWNA", "and SHPD's credit"}, null),
	ENGLISH("english",      "",   Status.UNFINISHED, new String[]{"Cocoa(Hoto-Mocha)", "and SHPD's credit"}, null),
	CHINESE("中文",          "zh", Status.UNFINISHED, new String[]{"Jinkeloid(zdx00793)", "endlesssolitude"}, new String[]{"931451545", "Budding", "Chronie_Lynn_Iwa", "Fatir", "Fishbone", "Hcat", "HoofBumpBlurryface", "Horr_lski", "Lery", "Lyn_0401", "Ooooscar", "ShatteredFlameBlast", "SpaceAnchor", "Teller", "hmdzl001", "leo", "tempest102", "户方狸奴"}),
	...
	TURKISH("türkçe",       "tr", Status.UNFINISHED, new String[]{"LokiofMillenium", "T3kin5iZ", "emrebnk", "gorkem_yılmaz"}, new String[]{"AGORAAA", "AchernarPrime", "AcuriousPotato", "MuratEfeYilmaz", "Mustafa.10", "OzanAlkan", "TR_Muhittin", "Talha_0_0", "ahmetbakicakir", "akkaya.mustafa", "alikeremozfidan", "alpekin98", "denizakalin", "eraysall402", "erdemozdemir98", "hasantahsin160", "immortalsamuraicn", "kayikyaki", "melezorus34", "mitux", "mustafadoslu", "ryuga", "yasirckr85", "yukete"}),
	...
	CZECH("čeština",        "cs", Status.UNFINISHED, new String[]{"ObisMike", "novotnyvaclav"}, new String[]{"16cnovotny", "AshenShugar", "Autony", "Block_Vader", "Buba237", "Nerdiniel", "JStrange", "RealBrofessor", "Thorn_123", "chuckjirka", "emteckos2", "kristanka"}),
	...
	HUNGARIAN("magyar",     "hu", Status.UNFINISHED, new String[]{"dorheim", "szalaik"}, new String[]{"Csanevox", "Navetelen", "acszoltan111", "clarovani", "dhialub", "nanometer", "nardomaa", "savarall", "summoner001", "szemetvodor"}),
	VIETNAMESE("tiếng việt","vi", Status.UNFINISHED, new String[]{"Chuseko", "The_Hood", "nguyenanhkhoapythus"}, new String[]{"BlueSheepAlgodoo", "Phuc2401", "Teh_boi", "Threyja", "Toluu", "bruhwut", "buicongminh_t63", "deadlevel13", "h4ndy_c4ndy", "hniV", "khangxyz3g", "ngolamaz3", "nkhhu", "vdgiapp", "vtvinh24"}),
