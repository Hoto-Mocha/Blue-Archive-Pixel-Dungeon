...
public class ShopRoom extends SpecialRoom {
	...
	protected static ArrayList<Item> generateItems() {
		...
		case 6: default:
			w = (MeleeWeapon) Generator.random(Generator.generateWep()[1]);
		...
		case 11:
			w = (MeleeWeapon) Generator.random(Generator.generateWep()[2]);
		...
		case 16:
			w = (MeleeWeapon) Generator.random(Generator.generateWep()[3]);
		...
		case 20: case 21:
			w = (MeleeWeapon) Generator.random(Generator.generateWep()[4]);
